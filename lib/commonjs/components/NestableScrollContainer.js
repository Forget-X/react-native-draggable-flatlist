...
var _jsxFileName =
    "/Users/karlsecen/code/Forget/react-native-draggable-flatlist/src/components/NestableScrollContainer.tsx",
  _this = this;
  ...
  var scrollHandler = (0, _reactNativeReanimated.useAnimatedScrollHandler)({
    onScroll: (function () {
      var _f = function _f(event) {
        ...
        (0, _reactNativeReanimated.runOnJS)(onScroll)(event.contentOffset.y);
      };
      _f._closure = {
      ...
      _f.asString =
        "function _f(event){const{outerScrollOffset,runOnJS,onScroll}=jsThis._closure;{outerScrollOffset.value=event.contentOffset.y;runOnJS(onScroll)(event.contentOffset.y);}}";
      _f.__workletHash = 17406490571891;
      _f.__location =
        "/Users/karlsecen/code/Forget/react-native-draggable-flatlist/src/components/NestableScrollContainer.tsx (38:14)";
      return _f;
    })(),
  });
